...
const Contact = () => {
  ...
  const onSubmit = async (event) => {
    ...
    formData.append("access_key", "f2a06ec5-dd0e-4b31-b160-9b21521fa5c8");
  ...
  return (
    ...
    whileInView={{opacity:1,x:0}} id='contact' className='text-center p-6 py-20 lg:px-32 w-full overflow-hidden'>
      ...
      <form onSubmit={onSubmit} className='max-w-2xl mx-auto text-gray-600 pt-8'>
        ...
        <div className='w-full md:w-1/2 text-left'>
          Your Name
        <input name='Name' className='w-full border border-gray-300 rounded py-3 px-4 mt-2' type="text" placeholder='Your Nmae ' required/>
        </div>
