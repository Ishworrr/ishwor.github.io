...
const Settings = () => {
  ...
  return (
    <div className='flex flex-sol items-center w-full'>
      <div className='w-full max-w-4xl px-4 py-4 my-6 shadow-lg bg-gray-50 dark:bg-black/20 md:px-10 md:my-10 '>
      
      <div className="mt-6 border-b-2 border-gray-200 dark:border-gray-200">
...
Profile Information
          ...
          <div className='flex items-center gap-4 my-8'>
            <div className='flex items-center justify-center w-12 h-12 text-white rounded-full cursor-pointer'>
              <p>{user?.firtsname.chartAt(0)}</p>
            </div>
            <p className='text-2xl text-black dark:text-gray-400 font-semibold'>
              {user?.firtsname}
            </p>
          </div>
