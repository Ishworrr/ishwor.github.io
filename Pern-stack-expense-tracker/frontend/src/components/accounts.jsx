...
const ICONS = {
  crypto: (
    <div className="w-12 h-12 bg-amber-600 text-white flex items-center justify-center rounded-full">
      <FaBtc className="w-6 h-6" size={26} />
    </div>
  ),
  "visa debit card": (
    <div className="w-12 h-12 bg-blue-600 text-white flex items-center justify-center rounded-full">
      <RiVisaLine className="w-6 h-6" size={26} />
    </div>
  ),
  cash: (
    <div className="w-12 h-12 bg-rose-600 text-white flex items-center justify-center rounded-full">
      <GiCash className="w-6 h-6" size={26} />
    </div>
  ),
  paypal: (
    <div className="w-12 h-12 bg-amber-600 text-white flex items-center justify-center rounded-full">
      <FaPaypal className="w-6 h-6" size={26} />
    </div>
  ),
};
        ...
        {data?.map((item, index) => (
          ...
          >
            <div className="flex items-center gap-4">
              ...
              <div>
                <p className="text-black text-base 2xl:text-lg dark:text-gray-400">
                  {item.account_name}
                </p>
